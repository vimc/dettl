...
The process can be run by first creating a new import object using the name of the directory containing the process you want to run. Again note that the `import_path` here is the path to import directory.
