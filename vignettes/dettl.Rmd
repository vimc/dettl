...
The default load can also load data respecting primary key constraints configured via `dettl.yml`. For example if we want to load data where we have `transformed_data` taking the form
